...
if("TRUE" STREQUAL "TRUE")
  set(moveit_fake_controller_manager_SOURCE_PREFIX /home/darian/al5b_ws/src/moveit/moveit_plugins/moveit_fake_controller_manager)
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/darian/al5b_ws/devel)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /home/darian/al5b_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/darian/al5b_ws/src/moveit/moveit_plugins/moveit_fake_controller_manager/${idir}'.  ${_report}")
    endif()
